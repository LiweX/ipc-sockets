...
server: server.c tools.o ipv4tcpserver.o ipv4udpserver.o ipv6server.o tools.o
	gcc $(CFLAGS) server.c -o server ipv4tcpserver.o ipv4udpserver.o ipv6server.o tools.o
...
ipv4tcpserver.o: ipv4tcpserver.c
